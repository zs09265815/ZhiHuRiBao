...
public class SystemUtil {
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager connectivityManager = (ConnectivityManager) BaseAppaplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int dp2px(float dpValue) {
        final float scale = BaseAppaplication.getInstance().getResources().getDisplayMetrics().density;
        return (int) (dpValue * scale + 0.5f);
    }
